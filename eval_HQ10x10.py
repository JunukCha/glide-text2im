...
def main():
    ...
    source_list = glob.glob("../../code/eval_output_HQ10x10_5/*/source.jpg")
    target_list = glob.glob("../../code/eval_output_HQ10x10_5/*/target.jpg")
    mask_list = glob.glob("../../code/eval_output_HQ10x10_5/*/mask.png")
    text_list = glob.glob("../../code/eval_output_HQ10x10_5/*/text.txt")
    source_list.sort()
    target_list.sort()
    mask_list.sort()
    text_list.sort()
    ...
    ssim_list = []
    lpips_list = []
    for index, (text_path, source_path, target_path, mask_path) in \
        tqdm.tqdm(enumerate(zip(text_list, source_list, target_list, mask_list)), total=len(text_list)):
        ...
        results_folder = f"eval_outputs_HQ10x10/{index:03d}"
